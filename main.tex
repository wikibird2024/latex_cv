...
% COLORS
%%%%%%%%%%%%%%%%%%%%%%%%%%
% ĐÃ SỬA: Đổi màu chính từ đen sang xanh đậm (Dark Blue)
\definecolor{primaryColor}{RGB}{0,0,200} % Dark Blue

%%%%%%%%%%%%%%%%%%%%%%%%%%
% SECTION FORMATTING
%%%%%%%%%%%%%%%%%%%%%%%%%%
% ĐÃ SỬA: Thêm \color{primaryColor} vào titleformat để đổi màu tiêu đề và gạch ngang
\titleformat{\section}{\needspace{4\baselineskip}\color{primaryColor}\bfseries\large}{}{0pt}{}[\vspace{1pt}\titlerule[1pt]]
...
% HEADER
%==============================
% Gợi ý: Bạn có thể thêm \color{primaryColor} vào đây nếu muốn tên John Doe cũng màu xanh
\begin{header}
